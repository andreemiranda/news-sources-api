...
```
bn_88feb5baa3f84955677e8c11453aae352811b9fe6c3398cd
```

> **Aviso:** Esta chave está embutida no código para fins de demonstração. Em produção, defina a variável de ambiente `API_KEY` para substituir a chave padrão.
...
1. **Header Authorization (Bearer Token):**
   ```
   Authorization: Bearer bn_88feb5baa3f84955677e8c11453aae352811b9fe6c3398cd
   ```

2. **Header x-api-key:**
   ```
   x-api-key: bn_88feb5baa3f84955677e8c11453aae352811b9fe6c3398cd
   ```

3. **Query parameter:**
   ```
   ?api_key=bn_88feb5baa3f84955677e8c11453aae352811b9fe6c3398cd
   ```
...
```bash
curl -H "x-api-key: bn_88feb5baa3f84955677e8c11453aae352811b9fe6c3398cd" \
